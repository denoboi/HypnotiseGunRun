...
namespace HCB.UI
{
    public class LevelLoadingPanel : HCBPanel
    {
        ...
        public override void ShowPanel()
        {
            ...
            sequence
                ...
                .Append(BlackKnob.DOScale(Vector3.one * 10, 1f).SetEase(Ease.InExpo));
        ...
        public override void HidePanel()
        {
            ...
            sequence
                .Append(CutoutKnob.DOScale(Vector3.one * 10, 1f).SetEase(Ease.InExpo))
